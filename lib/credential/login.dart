...
import 'package:inkc/credential/Forgotpassword.dart';
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(top: 10.sp, left: 20.sp, right: 20, bottom: 0),
                    child: Column(
                      children: [
                        Align(
                          alignment: Alignment.centerLeft,
                  ...
                  Container(
                    ...
                    child: Align(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.of(context, rootNavigator: true)
                              .push(MaterialPageRoute(builder: (_) => const Forgotpassword()));
                        },
                        child: Text(
                          'Forgot Passwrod',
                          style: TextStyle(
                              color: const Color.fromARGB(255, 18, 66, 223),
                              fontWeight: FontWeight.bold,
                              fontSize: 12.sp),
                        ),
                      ),
                              ...
                              if (data['code'] == 200) {
                                ...
                                if (data['data']['user_full_name'].toString() == "") {
                                  ...
                                  await EmpFullName.setString(
                                      "EmpFullName", data['data']['user_full_name']);
                                }
                                ...
                                await UserVerification.setString(
                                    "UserVerification", data['data']['is_verified']);
                                ...
                                await FontUserEmailId.setString(
                                    "FontUserEmailId", data['data']['user_email_id']);

                                SharedPreferences FontEmpTypeName =
                                    await SharedPreferences.getInstance();
                                await FontEmpTypeName.setString(
                                    "FontEmpTypeName", data['data']['emp_type_name']);

                                SharedPreferences FontPhoneNumber =
                                    await SharedPreferences.getInstance();
                                await FontPhoneNumber.setString(
                                    "FontPhoneNumber", data['data']['user_phone_number']);

                                SharedPreferences FontUserVerification =
                                    await SharedPreferences.getInstance();
                                await FontUserVerification.setString(
                                    "FontUserVerification", data['data']['is_verified']);
                                ...
                                await FontMemberStatus.setString(
                                    "FontMemberStatus", data['data']['member_status']);
                                ...
                                if (data['data']['user_profile_image'].toString() == "null") {
                                  ...
                                  await UserProfileImage.setString(
                                      "UserProfileImage", data['data']['user_profile_image']);
                                }
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(content: Text('InValide Credentials')));
                              }
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    'Sign up here ',
                                    style: TextStyle(
                                        color: const Color.fromARGB(255, 223, 18, 18),
                                        fontWeight: FontWeight.bold,
                                        fontSize: 20.sp),
                                  ),
                                ),
