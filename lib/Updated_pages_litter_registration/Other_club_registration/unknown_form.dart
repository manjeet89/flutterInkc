...
class UnknownFormOtherClub extends StatefulWidget {
  const UnknownFormOtherClub({super.key});

  @override
  _UnknownFormOtherClubState createState() => _UnknownFormOtherClubState();
}

class _UnknownFormOtherClubState extends State<UnknownFormOtherClub> {
  File? _image;
  File? _sirefrontside;
  File? _sirebackside;
  File? _damfrontside;
            ...
            return Scaffold(
              appBar: AppBar(
                ...
                title: const Column(
                  children: [
                    Text(
                      'Litter Registration Dam Register with Other Club',
                      style: TextStyle(
                          fontSize: 16,
