...
class OtherClubRegistrationFrom extends StatefulWidget {
  ...
  @override
  _OtherClubRegistrationFromState createState() => _OtherClubRegistrationFromState();
}
    ...
    try {
      ...
      if (_image.toString() == "null") {
        ...
        if (response.statusCode == 200) {
          ...
          var siretranferform = responseData['data']['other_club_transfer_form_sire'];
                            ...
                            children: [
                              ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  //     setState(() => _Siretransferformcertificate =
                                  //         File(cropperFile.path));
                                  //     print("justcheck$_Siretransferformcertificate");
                                  //   }
                                  // }
                                },
                                child: Icon(
