...
class InkcRegisteredForrm extends StatefulWidget {
  const InkcRegisteredForrm({super.key});

  @override
  _InkcRegisteredForrmState createState() => _InkcRegisteredForrmState();
}

class _InkcRegisteredForrmState extends State<InkcRegisteredForrm> {
  File? _image;
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      if (int.parse(numbers.text.toString()) <= 10) {
                                        UploadImage();
