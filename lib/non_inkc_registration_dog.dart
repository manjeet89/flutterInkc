...
class NonInkcRegistrationDog extends StatefulWidget {
  const NonInkcRegistrationDog({super.key});

  @override
  State<NonInkcRegistrationDog> createState() => _NonInkcRegistrationDogState();
}
...
class _NonInkcRegistrationDogState extends State<NonInkcRegistrationDog> {
  List<NonInkcRegistrationDogModel> dataload = [];
  var ifDataisnotavailavle;

  Future<List<NonInkcRegistrationDogModel>> FetchData() async {
    ...
    if (responce.statusCode == 200) {
      for (Map<String, dynamic> index in dataarray) {
        if (index['owner_id'].toString() == userid) {
          dataload.add(NonInkcRegistrationDogModel.fromJson(index));
        }
      }
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          FittedBox(
                                            fit: BoxFit.contain,
                                            child: AutoSizeText(
                                              dataload[position].petName.toString(),
                                              style: TextStyle(
                                                  fontSize: 17.sp,
                                                  color: Colors.black,
                                              ...
                                              onPressed: () {
                                                ...
                                                Navigator.of(context).push(MaterialPageRoute(
                                                    builder: (BuildContext context) =>
                                                        NonInkcDogDetails(
                                                            id: dataload[position].petId.toString(),
                                                            image: dataload[position]
                                                                .petImage
                                                                .toString(),
                                                            petnames: dataload[position]
                                                                .petName
                                                                .toString(),
                                                            dateofbirth: dataload[position]
                                                                .birthDate
                                                                .toString(),
                                                            sex: dataload[position]
                                                                .petGender
                                                                .toString(),
                                                            registernumber: dataload[position]
                                                                .petRegistrationNumber
                                                                .toString(),
                                                            breed: dataload[position]
                                                                .subCategoryName
                                                                .toString(),
                                                            colorandmaking: dataload[position]
                                                                .colorMarking
                                                                .toString())));
                                              },
                                              child: const Text(
