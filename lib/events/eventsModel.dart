class EventsModel {
  ...
  EventsModel.fromJson(Map<String, dynamic> json) {
    ...
    priceWorking = json['price_working'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_special_event'] = isSpecialEvent;
    data['event_breed'] = eventBreed;
    data['event_name_suff'] = eventNameSuff;
    data['event_name'] = eventName;
    data['event_slug'] = eventSlug;
    data['event_image'] = eventImage;
    data['is_event_parent'] = isEventParent;
    data['price_working'] = priceWorking;
    data['parent_event_id'] = parentEventId;
    data['event_class_price'] = eventClassPrice;
    data['class_price_value_non_inkc'] = classPriceValueNonInkc;
    data['dog_price_discount'] = dogPriceDiscount;
    data['event_stall'] = eventStall;
    data['event_obedience_price'] = eventObediencePrice;
    data['event_stall_price_ac'] = eventStallPriceAc;
    data['event_stall_price_fan'] = eventStallPriceFan;
    data['event_judge'] = eventJudge;
    data['event_venue'] = eventVenue;
    data['event_address'] = eventAddress;
    data['event_location'] = eventLocation;
    data['event_contact_person'] = eventContactPerson;
    data['event_description'] = eventDescription;
    data['event_start_date_time'] = eventStartDateTime;
    data['event_end_date_time'] = eventEndDateTime;
    data['event_entry_closed_on'] = eventEntryClosedOn;
    data['best_in_group'] = bestInGroup;
    data['best_in_show'] = bestInShow;
    data['allowed_audience'] = allowedAudience;
    data['audience_entry_fee'] = audienceEntryFee;
    data['audience_entry_fee_dog'] = audienceEntryFeeDog;
    data['event_entry_fees'] = eventEntryFees;
    data['event_status'] = eventStatus;
    data['event_updated_on'] = eventUpdatedOn;
    data['event_created_on'] = eventCreatedOn;
