...
class Firstupdateprofile extends StatefulWidget {
  Firstupdateprofile({
    super.key,
  });

  @override
  State<Firstupdateprofile> createState() => _FirstupdateprofileState();
}

class _FirstupdateprofileState extends State<Firstupdateprofile> {
                            ...
                            children: <Widget>[
                              ...
                              ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    // print(
                                    //     "${email.text} $valuechoose ${state.text} ${pincode.text} ${address1.text} ${address2.text} ${district.text} ${phonenumber.text}");
