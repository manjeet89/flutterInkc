...
class DamRegistrationWithOtherClubSireUnkown extends StatefulWidget {
  const DamRegistrationWithOtherClubSireUnkown({super.key});

  @override
  _DamRegistrationWithOtherClubSireUnkownState createState() =>
      _DamRegistrationWithOtherClubSireUnkownState();
}

class _DamRegistrationWithOtherClubSireUnkownState
    extends State<DamRegistrationWithOtherClubSireUnkown> {
  File? _image;
            ...
            return Scaffold(
              appBar: AppBar(
                ...
                title: const Column(
                  children: [
                    Text(
                      "Dam's Registered With Other Clubs",
                      style: TextStyle(
                          fontSize: 16,
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (files.isNotEmpty) {
                                        ...
                                        if (cropperFile != null) {
                                          ...
                                          print("justcheck$_damfrontsidecertificate");
                                        }
                                      }
                                    },
                                    child: const Text(
                                      ...
                                      if (files.isNotEmpty) {
                                        ...
                                        if (cropperFile != null) {
                                          setState(() =>
                                              _dambacksidecertificate =
                                                  File(cropperFile.path));
                                          print("justcheck$_dambacksidecertificate");
                                        }
                                      }
                                    },
                                    child: const Text(
