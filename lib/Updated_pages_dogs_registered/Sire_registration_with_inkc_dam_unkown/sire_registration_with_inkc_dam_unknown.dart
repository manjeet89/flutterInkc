...
class SireRegistrationWithInkcDamUnknown extends StatefulWidget {
  const SireRegistrationWithInkcDamUnknown({super.key});

  @override
  _SireRegistrationWithInkcDamUnknownState createState() =>
      _SireRegistrationWithInkcDamUnknownState();
}

class _SireRegistrationWithInkcDamUnknownState
    extends State<SireRegistrationWithInkcDamUnknown> {
  File? _image;
  ...
  uploadData() async {
    ...
    try {
      ...
      print('no image  selected false$e');
    }
  }
