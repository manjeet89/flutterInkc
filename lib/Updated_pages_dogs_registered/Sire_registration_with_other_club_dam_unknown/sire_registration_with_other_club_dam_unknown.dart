...
class SireRegistrationWithOtherClubDamUnknown extends StatefulWidget {
  const SireRegistrationWithOtherClubDamUnknown({super.key});

  @override
  _SireRegistrationWithOtherClubDamUnknownState createState() =>
      _SireRegistrationWithOtherClubDamUnknownState();
}

class _SireRegistrationWithOtherClubDamUnknownState
    extends State<SireRegistrationWithOtherClubDamUnknown> {
  File? _image;
  File? _sirefrontsidecertificate;
  File? _sirebacksidecertificate;
  File? _damfrontsidecertificate;
            ...
            return Scaffold(
              appBar: AppBar(
                ...
                title: const Column(
                  children: [
                    Text(
                      "Sire's Registered With Other Clubs",
                      style: TextStyle(
                          fontSize: 16,
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (files.isNotEmpty) {
                                        ...
                                        if (cropperFile != null) {
                                          ...
                                          print("justcheck$_sirefrontsidecertificate");
                                        }
                                      }
                                    },
                                    child: const Text(
                                      ...
                                      if (files.isNotEmpty) {
                                        ...
                                        if (cropperFile != null) {
                                          setState(() =>
                                              _sirebacksidecertificate =
                                                  File(cropperFile.path));
                                          print("justcheck$_sirebacksidecertificate");
                                        }
                                      }
                                    },
                                    child: const Text(
                                ...
                                children: [
                                  FittedBox(
                                    ...
                                    child: CircleAvatar(
                                      backgroundColor: const Color(0xEBA020F0),
                                      radius: 64,
                                      foregroundImage: _studcertificate != null
                                          ? FileImage(_studcertificate!)
                                          : null,
                                      child: const Text(
                                        "Select image",
                                        style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      if (_damfrontsidecertificate.toString() ==
                                          "null") {
                                        QuickAlert.show(
                                          context: context,
