...
class DamRegistrationWithInkc extends StatefulWidget {
  const DamRegistrationWithInkc({super.key});

  @override
  _DamRegistrationWithInkcState createState() =>
      _DamRegistrationWithInkcState();
}
  ...
  uploadData() async {
    ...
    try {
      ...
      Response response = await dio.post(
          'https://new-demo.inkcdogs.org/api/dog/damregistrationwithINKC',
          data: formData,
                                    ...
                                    onPressed: () {
                                      ...
                                      if (SIRE.toString() == "") {
                                        ...
                                        QuickAlert.show(
                                          ...
                                          title: 'Oops...',
                                          text:
                                              "Please Select sire front side certificate",
                                        );
                                        ...
                                        QuickAlert.show(
                                          ...
                                          title: 'Oops...',
                                          text:
                                              "Please Select sire back side certificate",
                                        );
