...
class DamRegistrationWithInkc extends StatefulWidget {
  ...
  @override
  _DamRegistrationWithInkcState createState() => _DamRegistrationWithInkcState();
}

class _DamRegistrationWithInkcState extends State<DamRegistrationWithInkc> {
  File? _image;
  ...
  uploadData(String obidientq, String stallReqq, String Dayq, String Typeq) async {
    ...
    try {
      ...
      FormData formData = FormData.fromMap({
        ...
        'sire_front_side_certificate': await MultipartFile.fromFile(_dambacksidecertificate!.path,
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      "Sire's(Father's) KCI front side of the certificate",
                                      style: TextStyle(
                                          color: const Color.fromARGB(255, 22, 21, 21),
                                          fontWeight: FontWeight.bold,
                                          fontSize: 11.sp),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      "Sire's(Father's) KCI back side of the certificate",
                                      style: TextStyle(
                                          color: const Color.fromARGB(255, 22, 21, 21),
                                          fontWeight: FontWeight.bold,
                                          fontSize: 11.sp),
                                    ...
                                    onPressed: () {
                                      ...
                                      if (SIRE.toString() == "") {
                                        ...
                                        QuickAlert.show(
                                          ...
                                          type: QuickAlertType.error,
                                          title: 'Oops...',
                                          text: "Please Select sire front side certificate",
                                        );
                                        ...
                                        QuickAlert.show(
                                          ...
                                          type: QuickAlertType.error,
                                          title: 'Oops...',
                                          text: "Please Select sire back side certificate",
                                        );
